...
Cadastra um cliente.
Registra o histórico do atendimento.
Adiciona observações gerais.
Agenda um retorno, quando necessário.
Consulta ou pesquisa clientes.
Edita informações sempre que necessário.
Exclui clientes com confirmação.
Visualiza indicadores no Dashboard.
...
Java (Back-end)
Java Swing ou JavaFX (Interface Desktop) ou HTML, CSS e JavaScript (caso seja Web)
